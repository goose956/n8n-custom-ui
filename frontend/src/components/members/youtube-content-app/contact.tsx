...
export function MembersContactPage() {
 ...
 const infoCards = [
  { icon: <Chat />, title: 'Email Support', desc: 'Response time within 24 hours', color: COLORS.primary },
  { icon: <AccessTime />, title: 'Live Chat', desc: 'Available Monday to Friday, 9 AM - 5 PM', color: COLORS.blue },
  { icon: <SupportAgent />, title: 'Help Center', desc: 'Explore FAQs and guides anytime', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>We're here to help you succeed on YouTube - reach out to us!</Typography>
    </Box>
   </Paper>
