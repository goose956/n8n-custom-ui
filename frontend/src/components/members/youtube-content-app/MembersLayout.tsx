...
const navItems = [
    ...
    { path: '/script-creator', label: 'Script Creator', icon: <Article /> },
    { path: '/email-scraper', label: 'Email Scraper', icon: <Article /> },
    { path: '/transcriptions', label: 'Transcriptions', icon: <Article /> },
    { path: '/thumbnail-creator', label: 'Thumbnail Creator', icon: <Article /> },
