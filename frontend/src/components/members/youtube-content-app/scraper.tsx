...
const API_URL = `${API_BASE}/api/youtube-content-app-scraper`;

interface ScraperResult {
  [key: string]: any;
}

export function MembersYoutubeContentAppScraperPage() {
  ...
  const exportCsv = () => {
    ...
    a.href = url;
    a.download = `youtube-content-app-scraper-results.csv`;
    a.click();
        ...
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
            ...
            <Typography variant="h5" sx={{ fontWeight: 800 }}>
              youtube content app Scraper
            </Typography>
          </Box>
          <Typography variant="body2" sx={{ opacity: 0.9, maxWidth: 600 }}>
            Run Apify scrapers, view results, and export data. Connect any Apify actor to power your youtube content app integrations.
          </Typography>
        </Box>
      </Paper>
