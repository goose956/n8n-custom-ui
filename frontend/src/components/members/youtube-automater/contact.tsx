...
export function MembersContactPage() {
 ...
 const infoCards = [
  { icon: <Chat />, title: 'Email Support', desc: 'Available 24/7 for all your questions.', color: COLORS.primary },
  { icon: <AccessTime />, title: 'Live Chat', desc: 'Monday to Friday, 9 AM - 5 PM PST.', color: COLORS.blue },
  { icon: <SupportAgent />, title: 'Help Center', desc: 'Access FAQs and tutorials anytime.', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>We're here to help you amplify your YouTube success. Reach out to us anytime!</Typography>
    </Box>
   </Paper>
