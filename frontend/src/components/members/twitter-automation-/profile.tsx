...
export function MembersProfilePage() {
 ...
 const [profile, setProfile] = useState({
  ...
  bio: 'Maximize your Twitter presence effortlessly with our automation tool that curates content and engages followers automatically.', joinDate: '2025-06-15', plan: 'Pro',
 });
