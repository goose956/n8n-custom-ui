...
export function MembersContactPage() {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
   const res = await fetch(API + '/api/contact', {
    ...
    body: JSON.stringify({ ...form, app_id: 10 }),
   });
 ...
 const infoCards = [
  { icon: <Chat />, title: 'Live Chat Support', desc: 'Available 24/7 for immediate assistance.', color: COLORS.primary },
  { icon: <AccessTime />, title: 'Email Support', desc: 'Reach us at support@linkedinautomater.com, response within 48 hours.', color: COLORS.blue },
  { icon: <SupportAgent />, title: 'Knowledge Base', desc: 'Access articles and guides anytime for self-help.', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>Have questions? We're here to help!</Typography>
    </Box>
   </Paper>
