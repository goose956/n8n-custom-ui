...
export function MembersContactPage() {
 ...
 const infoCards = [
  ...
  { icon: <AccessTime />, title: 'Live Chat', desc: 'Join us from 9 AM to 5 PM EST.', color: COLORS.blue },
  { icon: <SupportAgent />, title: 'Community Forum', desc: 'Interact with other users anytime.', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>We're here to help you succeed on Twitter!</Typography>
    </Box>
   </Paper>
