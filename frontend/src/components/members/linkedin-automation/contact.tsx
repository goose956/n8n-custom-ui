...
export function MembersContactPage() {
 ...
 const infoCards = [
  { icon: <Chat />, title: 'Email Support', desc: 'Available 24/7 for inquiries.', color: COLORS.primary },
  { icon: <AccessTime />, title: 'Live Chat', desc: 'Reach us during business hours for quick assistance.', color: COLORS.blue },
  { icon: <SupportAgent />, title: 'Community Forum', desc: 'Engage with other users and share tips.', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>We're here to help you succeed with your LinkedIn automation.</Typography>
    </Box>
   </Paper>
