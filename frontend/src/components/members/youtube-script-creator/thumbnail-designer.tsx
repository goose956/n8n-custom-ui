...
export function MembersThumbnailDesignerPage() {
 return (
  <Box sx={{ p: 3, background: '#fafbfc', minHeight: '100vh' }}>
   <Box sx={{ mb: 4, textAlign: 'center', background: 'linear-gradient(135deg, #1976d2, #5147ad)', color: '#fff', py: 4, borderRadius: 16 }}>
    <Typography variant="h4" sx={{ fontWeight: 700 }}>Thumbnail Designer</Typography>
    <Typography variant="body1" sx={{ mt: 1 }}>Create stunning video thumbnails with AI-powered tools and customizable templates.</Typography>
   </Box>
   ...
   <Grid container spacing={3}>
    <Grid item xs={12} sm={6} md={4}>
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', borderRadius: 16, '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' } }}>
      <CardContent>
       <Typography variant="h6" gutterBottom>Create Eye-Catching Designs</Typography>
       <Typography variant="body2">Utilize AI suggestions to enhance your thumbnail's visual appeal.</Typography>
      </CardContent>
     </Card>
    </Grid>
    <Grid item xs={12} sm={6} md={4}>
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', borderRadius: 16, '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' } }}>
      <CardContent>
       <Typography variant="h6" gutterBottom>Customizable Templates</Typography>
       <Typography variant="body2">Choose from a variety of templates and tailor them to your needs.</Typography>
      </CardContent>
     </Card>
    </Grid>
    <Grid item xs={12} sm={6} md={4}>
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', borderRadius: 16, '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' } }}>
      <CardContent>
       <Typography variant="h6" gutterBottom>Analyze Impact</Typography>
       <Typography variant="body2">Use predictive analysis to gauge how well your design will perform.</Typography>
      </CardContent>
     </Card>
    </Grid>
   </Grid>
   ...
   <Box sx={{ mt: 4 }}>
    <SkillWidget placeholder="Describe your thumbnail design needs..." title="Thumbnail AI Designer" />
   </Box>
  </Box>
 );
}