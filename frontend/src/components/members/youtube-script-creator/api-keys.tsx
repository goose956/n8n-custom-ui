    ...
    <Box sx={{ position: 'relative', zIndex: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
     <Box>
      <Typography variant="h4" sx={{ fontWeight: 800, display: 'flex', alignItems: 'center', gap: 1 }}>
       <VpnKey /> YouTube script creator API Keys
      </Typography>
      <Typography sx={{ opacity: 0.85, mt: 0.5 }}>Manage your API keys to access additional integrations and enhance your content creation process.</Typography>
     </Box>
