...
export function MembersContactPage() {
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
   const res = await fetch(API + '/api/contact', {
    ...
    body: JSON.stringify({ ...form, app_id: 15 }),
   });
 ...
 const infoCards = [
  ...
  { icon: <SupportAgent />, title: 'Knowledge Base', desc: 'Access guides and FAQs anytime.', color: COLORS.success },
 ];
  ...
  <Box sx={{ maxWidth: 800, mx: 'auto' }}>
   <Paper sx={heroSx}>
    ...
    <Box sx={{ position: 'relative', zIndex: 1 }}>
     ...
     <Typography variant="body1" sx={{ opacity: 0.85, mt: 0.5 }}>Have questions or need assistance? We're here to help!</Typography>
    </Box>
   </Paper>
