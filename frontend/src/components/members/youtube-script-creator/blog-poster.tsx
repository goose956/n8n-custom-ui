...
export function MembersBlogPosterPage() {
 return (
  <Box sx={{ px: 3, py: 4, maxWidth: 900, mx: 'auto' }}>
   <Box sx={{ mb: 4, textAlign: 'center' }}>
    <Typography variant="h3" sx={{ mb: 2, color: '#1976d2', fontWeight: 'bold' }}>Create Blog Post Drafts</Typography>
    <Typography variant="h6" sx={{ mb: 2, color: 'text.secondary' }}>
     Utilize our AI-powered script creator to turn your YouTube video script ideas into engaging blog posts instantly!
    </Typography>
   </Box>
     ...
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' }, borderRadius: 3 }}>
      <CardContent>
       <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
        ...
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Scripts Generated</Typography>
       </Box>
       <Typography variant="h4" sx={{ color: '#27ae60', fontWeight: 'bold' }}>245 <Chip label="▲ 5%" color="success" size="small" sx={{ ml: 1 }} /></Typography>
      </CardContent>
     </Card>
    </Grid>
    ...
    <Grid item xs={12} sm={6} md={4}>
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' }, borderRadius: 3 }}>
      <CardContent>
       <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
        <SmartToyIcon sx={{ color: '#1976d2', mr: 1 }} />
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Email Scrapes</Typography>
       </Box>
       <Typography variant="h4" sx={{ color: '#f39c12', fontWeight: 'bold' }}>158 <Chip label="▼ 2%" color="warning" size="small" sx={{ ml: 1 }} /></Typography>
      </CardContent>
     </Card>
    </Grid>
    ...
    <Grid item xs={12} sm={6} md={4}>
     <Card sx={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)', '&:hover': { transform: 'translateY(-2px)', transition: '0.2s' }, borderRadius: 3 }}>
      <CardContent>
       <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
        <SmartToyIcon sx={{ color: '#1976d2', mr: 1 }} />
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Transcriptions Done</Typography>
       </Box>
       <Typography variant="h4" sx={{ color: '#e74c3c', fontWeight: 'bold' }}>302 <Chip label="▲ 8%" color="success" size="small" sx={{ ml: 1 }} /></Typography>
      </CardContent>
     </Card>
    </Grid>
   </Grid>
   ...
   <Box sx={{ mt: 4 }}>
    <SkillWidget placeholder="Describe your blog post needs..." title="Blog Post AI" />
   </Box>
  </Box>
 );
}