...
@Controller('api/youtube-automations-scraper')
export class YoutubeAutomationsScraperController {
  constructor(private readonly scraperService: YoutubeAutomationsScraperService) {}
