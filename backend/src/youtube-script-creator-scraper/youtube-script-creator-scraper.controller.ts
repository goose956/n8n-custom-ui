...
@Controller('api/youtube-script-creator-scraper')
export class YoutubeScriptCreatorScraperController {
  constructor(private readonly scraperService: YoutubeScriptCreatorScraperService) {}
