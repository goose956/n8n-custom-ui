...
@Controller('api/linkedin-powerhouse-scraper')
export class LinkedinPowerhouseScraperController {
  constructor(private readonly scraperService: LinkedinPowerhouseScraperService) {}
