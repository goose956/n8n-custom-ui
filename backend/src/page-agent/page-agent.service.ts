...
4. Format responses clearly with task status icons: [OK] done, [ ] pending, in-progress.
...
'Content-Type':'application/json',
 ...
 const icon = t.status ==='done' ?'[OK]' : t.status ==='in-progress' ?'' :'[ ]';
