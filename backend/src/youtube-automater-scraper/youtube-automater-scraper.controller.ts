...
@Controller('api/youtube-automater-scraper')
export class YoutubeAutomaterScraperController {
  constructor(private readonly scraperService: YoutubeAutomaterScraperService) {}
