...
@Controller('api/pinterest-updater-scraper')
export class PinterestUpdaterScraperController {
  constructor(private readonly scraperService: PinterestUpdaterScraperService) {}
